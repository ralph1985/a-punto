...
type VehicleOverviewProps = { vehicle: { name: string; brand: string; model: string; year: number | null; slug: VehicleRouteSlug; tasks: Array<{ id: string; title: string; evaluation: { status: string; reasons: string[] } }> } };
