...
import { CarProfile, Gauge } from "@phosphor-icons/react/dist/ssr";
import { BrandCar } from "@/components/brand-car";
import type { VehicleRouteSlug } from "@/lib/vehicle-routes";

const items = [{ href: "/", label: "Hoy", id: "today", icon: Gauge }, { href: "/punto", label: "Punto", id: "punto", icon: CarProfile }, { href: "/rifter", label: "Rifter", id: "rifter", icon: CarProfile }] as const;
